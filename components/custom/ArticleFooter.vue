          ...
          <ul class="flex text-center rewards-box">
            <li>
              ...
              <div class="rewards-img">
                <img class="fit-cover" :src="article.expand.author.pay.wechat_pay || null_qrcode" alt="">
              </div>
            </li>
            <li>
              <p class="text-color">支付宝扫一扫</p>
              <div class="rewards-img">
                <img class="fit-cover" :src="article.expand.author.pay.alipay || null_qrcode" alt="">
              </div>
            </li>
          </ul>
...
.geek-isDark {
  .modal-content {
    ...
    .modal-body {
      ...
      .rewards-box p, .modal-footer div {
        color: #000 !important;
      }
    }
  }
